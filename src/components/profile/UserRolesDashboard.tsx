...
export const UserRolesDashboard: React.FC<UserRolesDashboardProps> = ({ onRouteChange }) => {
  ...
  const rolesList: {
    ...
    },
    {
      ...
      title: `Suscriptor Plan ${PLAN_LIMITS.solo.name}`,
      badge: `${PLAN_LIMITS.solo.name} ($${PLAN_LIMITS.solo.annualPriceUsd}/mes)`,
      icon: <Zap className="w-5 h-5 text-teal-400" />,
      color: 'border-teal-500/30 bg-teal-500/5',
      description: PLAN_LIMITS.solo.description,
      features: [
        `Hasta ${PLAN_LIMITS.solo.maxLeadsPerMonth} Interacciones Mensuales`,
        `Búsqueda RAG sobre ${PLAN_LIMITS.solo.maxProperties} Inmuebles`,
    ...
    {
      id: 'subscriber_pro',
      title: `Suscriptor Plan ${PLAN_LIMITS.pro.name}`,
      badge: `Recomendado ($${PLAN_LIMITS.pro.annualPriceUsd}/mes)`,
      icon: <Crown className="w-5 h-5 text-amber-400" />,
      color: 'border-amber-500/40 bg-amber-500/10',
      description: PLAN_LIMITS.pro.description,
      features: [
        `Hasta ${PLAN_LIMITS.pro.maxLeadsPerMonth} Interacciones Mensuales`,
        `Búsqueda RAG sobre ${PLAN_LIMITS.pro.maxProperties} Inmuebles`,
    ...
    },
    {
      ...
      title: `Suscriptor Plan ${PLAN_LIMITS.desarrolladores.name}`,
      badge: 'A Medida',
