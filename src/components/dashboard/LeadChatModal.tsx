          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {/* Handover AI Mode Badge */}
                {lead.status === 'handover' ? (
                  <span className="px-2.5 py-0.5 rounded-md text-[10px] font-extrabold bg-amber-500/20 text-amber-300 border border-amber-500/40 animate-pulse">
                    🤖 IA Pausada - Modo Asesor Humano
                  </span>
                ) : (
                  <span className="px-2.5 py-0.5 rounded-md text-[10px] font-extrabold bg-emerald-500/20 text-emerald-300 border border-emerald-500/40">
                    ✨ IA Activa
                  </span>
                )}
              </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {lead.status === 'handover' ? (
              <button
                ...
                className="px-3 py-1.5 rounded-xl bg-emerald-500/20 hover:bg-emerald-500/30 text-emerald-300 border border-emerald-500/30 text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5"
                title="Reactivar respuesta automática de Aria IA"
              >
              ...
              <button
                disabled={updatingStatus}
                onClick={() => handleUpdateStatus('handover')}
                className="px-3 py-1.5 rounded-xl bg-amber-500/20 hover:bg-amber-500/30 text-amber-300 border border-amber-500/30 text-xs font-bold transition-all cursor-pointer flex items-center gap-1.5"
                title="Pausar respuestas automáticas de IA para tomar el chat manualmente"
              >
                <Sparkles className="w-3.5 h-3.5 text-amber-400" />
                <span className="hidden sm:inline">Pausar IA / Control Manual</span>
              </button>
            )}
