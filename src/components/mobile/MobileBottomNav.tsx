...
export const MobileBottomNav: React.FC<MobileBottomNavProps> = ({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 w-full max-w-full overflow-hidden bg-slate-950/95 backdrop-blur-2xl border-t border-white/10 px-1 sm:px-2 py-1.5 pb-safe shadow-2xl">
