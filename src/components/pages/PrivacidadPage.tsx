    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 flex flex-col font-sans selection:bg-emerald-500 selection:text-slate-950">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10 text-xs sm:text-sm leading-relaxed text-slate-300">
        ...
        <section className="space-y-3">
          ...
          <p>
            {isEn
              ? 'Aria Prop ("Company", "we") is committed to protecting the privacy of real estate agencies, independent brokers, and their leads. The entity responsible for processing your account data is MORALES VALENTIN LAUTARO.'
              : isPt
              ? 'A Aria Prop está comprometida em proteger a privacidade das agências e corretores. O responsável pelo tratamento dos dados é MORALES VALENTIN LAUTARO.'
              : 'Aria Prop ("La Empresa") se compromete a proteger la privacidad de las agencias inmobiliarias, corredores independientes y prospectos. El responsable del tratamiento de los datos de su cuenta es MORALES VALENTIN LAUTARO.'}
          </p>
        </section>
