  ...
  const plans = [
    {
      ...
      tagline: PLAN_LIMITS.solo.description,
      ...
      features: [
        ...
        `Catálogo de hasta ${PLAN_LIMITS.solo.maxProperties} Inmuebles`,
    ...
    },
    {
      ...
      tagline: PLAN_LIMITS.pro.description,
      ...
      features: [
        ...
        `Catálogo de hasta ${PLAN_LIMITS.pro.maxProperties} Inmuebles`,
    ...
    {
      id: 'custom',
      name: `${PLAN_LIMITS.desarrolladores.name} / Desarrolladores`,
      tagline: PLAN_LIMITS.desarrolladores.description,
      isCustom: true,
      monthlyPrice: 0,
      annualPrice: 0,
      features: [
