...
const PUBLIC_ROUTES = [
  ...
  {
    path: '/terminos',
    title: 'Términos de Servicio | Aria Prop',
    description: 'Términos y condiciones para usar AriaPrompt / Aria Prop AI.',
    ogTitle: 'Términos de Servicio | Aria Prop',
    ogDescription: 'Condiciones generales de uso de AriaPrompt / Aria Prop AI.',
    ogImage: `${BASE_URL}/assets/og-home.jpg`,
    contentHtml: `<div id="static-prerender-wrapper" class="bg-slate-950 text-slate-100 min-h-screen font-sans"><main class="max-w-4xl mx-auto px-4 py-8 space-y-4"><p class="text-emerald-400 text-xs font-bold uppercase tracking-widest">Legal</p><h1 class="text-3xl font-black text-white">Términos y Condiciones</h1><p class="text-slate-300">Condiciones generales para acceder y usar la plataforma AriaPrompt / Aria Prop AI.</p><p class="text-slate-400 text-sm">Al acceder o utilizar AriaPrompt aceptas estos Términos de Servicio, incluyendo uso permitido, pagos, disponibilidad, responsabilidades y contacto legal.</p><nav class="flex flex-wrap gap-4 text-sm"><a href="/terminos" class="text-emerald-300 underline">Términos de Servicio</a><a href="/privacidad" class="text-emerald-300 underline">Política de Privacidad</a><a href="/reembolso" class="text-emerald-300 underline">Política de Reembolso (14 Días)</a></nav></main></div>`,
  },
  {
    path: '/privacidad',
    title: 'Política de Privacidad | Aria Prop',
    description: 'Política de privacidad de AriaPrompt / Aria Prop AI.',
    ogTitle: 'Política de Privacidad | Aria Prop',
    ogDescription: 'Cómo AriaPrompt recopila, usa, comparte y protege información personal.',
    ogImage: `${BASE_URL}/assets/og-home.jpg`,
    contentHtml: `<div id="static-prerender-wrapper" class="bg-slate-950 text-slate-100 min-h-screen font-sans"><main class="max-w-4xl mx-auto px-4 py-8 space-y-4"><p class="text-emerald-400 text-xs font-bold uppercase tracking-widest">Legal</p><h1 class="text-3xl font-black text-white">Política de Privacidad</h1><p class="text-slate-300">Explica cómo AriaPrompt recopila, usa, comparte y protege la información personal.</p><p class="text-slate-400 text-sm">Tratamos datos de cuenta, contacto, facturación, uso, archivos y conversaciones para prestar el servicio, procesar pagos, dar soporte y cumplir obligaciones legales.</p><nav class="flex flex-wrap gap-4 text-sm"><a href="/terminos" class="text-emerald-300 underline">Términos de Servicio</a><a href="/privacidad" class="text-emerald-300 underline">Política de Privacidad</a><a href="/reembolso" class="text-emerald-300 underline">Política de Reembolso (14 Días)</a></nav></main></div>`,
  },
  {
    path: '/reembolso',
    title: 'Política de Reembolso de 14 Días | Aria Prop',
    description: 'Garantía de reembolso de 14 días para nuevas suscripciones de AriaPrompt.',
    ogTitle: 'Política de Reembolso (14 Días) | Aria Prop',
    ogDescription: 'Condiciones de elegibilidad y procesamiento de reembolsos de AriaPrompt.',
    ogImage: `${BASE_URL}/assets/og-home.jpg`,
    contentHtml: `<div id="static-prerender-wrapper" class="bg-slate-950 text-slate-100 min-h-screen font-sans"><main class="max-w-4xl mx-auto px-4 py-8 space-y-4"><p class="text-emerald-400 text-xs font-bold uppercase tracking-widest">Legal</p><h1 class="text-3xl font-black text-white">Política de Reembolso (14 Días)</h1><p class="text-slate-300">Condiciones de la garantía de reembolso para nuevas suscripciones de AriaPrompt.</p><p class="text-slate-400 text-sm">La garantía aplica durante 14 días naturales desde la compra inicial elegible. Los reembolsos aprobados se devuelven al método de pago original mediante Paddle u otro proveedor aplicable.</p><nav class="flex flex-wrap gap-4 text-sm"><a href="/terminos" class="text-emerald-300 underline">Términos de Servicio</a><a href="/privacidad" class="text-emerald-300 underline">Política de Privacidad</a><a href="/reembolso" class="text-emerald-300 underline">Política de Reembolso (14 Días)</a></nav></main></div>`,
  },
  {
